...
coverage: ## check code coverage quickly with the default Python
	coverage run --source reference_handler -m pytest
	coverage report -m
	coverage html
	$(BROWSER) htmlcov/index.html

docs: ## generate Sphinx HTML documentation, including API docs
	rm -f docs/reference_handler.rst
	rm -f docs/reference_handler.tests.rst
	rm -f docs/modules.rst
	sphinx-apidoc -o docs/ reference_handler
	$(MAKE) -C docs clean
	$(MAKE) -C docs html
